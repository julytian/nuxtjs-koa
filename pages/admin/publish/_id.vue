    ...
    <div class="admin-publish container">
        ...
        <div class="publish-handle">
            ...
            <ul class="handle-tag">
                <li v-for="(item, index) in article.tags"
                    :key="index"> {{ item.name }}
                    <span @click="delTag(item, index)">&times;</span>
                </li>
            </ul>
            <div class="handle-button">
                <button class="button-private"
                    @click="publish(false)">存草稿</button>
                <button class="black-button"
                    @click="publish(true)">发布</button>
            </div>
        </div>
        <div class="publish-tags">
            ...
            <a v-for="(tag,index) in tags"
                :key="index"
                @click="chooseTag(tag)">{{ tag.name }}</a>
        </div>
        <Tip ref="tip"></Tip>
    </div>
</template>
